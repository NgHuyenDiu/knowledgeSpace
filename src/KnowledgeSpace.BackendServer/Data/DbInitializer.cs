        ...
        public async Task Seed()
        {
            ...
            if (!_context.Functions.Any())
            {
                _context.Functions.AddRange(new List<Function>
                {
                    ...
                    new Function {Id = "STATISTIC_MONTHLY_NEWMEMBER",Name = "Đăng ký theo tháng",ParentId = "STATISTIC",SortOrder = 1,Url = "/statistics/monthly-registers",Icon = "fa-wrench"},
                    new Function {Id = "STATISTIC_MONTHLY_NEWKB",Name = "Bài viết theo tháng",ParentId = "STATISTIC",SortOrder = 2,Url = "/statistics/monthly-newkbs",Icon = "fa-wrench"},
                    new Function {Id = "STATISTIC_MONTHLY_COMMENT",Name = "Bình luận theo tháng",ParentId = "STATISTIC",SortOrder = 3,Url = "/statistics/monthly-comments",Icon = "fa-wrench" },
