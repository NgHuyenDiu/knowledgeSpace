...
import { Function, Pagination, CommandAssign, Command } from '../models';
...
export class FunctionsService extends BaseService {
    ...
    getAllCommandsByFunctionId(functionId: string) {
        return this.http.get<Command[]>(`${environment.apiUrl}/api/functions/${functionId}/commands`, { headers: this._sharedHeaders })
